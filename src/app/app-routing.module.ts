...
const routes: Routes = [
  ...
  // { path: 'verify-deliveries2',    loadChildren: './verify-deliveries2/verify-deliveries2.module#VerifyDeliveries2PageModule' },
  ...
  { path: 'construction', loadChildren: './construction/construction.module#ConstructionPageModule' },
    { path: 'construction/new-construction',                        loadChildren: './construction/new-construction/new-construction.module#NewConstructionPageModule' },
    { path: 'construction/view-past-construction',                  loadChildren: './construction/view-past-construction/view-past-construction.module#ViewPastConstructionPageModule' },
      { path: 'construction/project-details',                       loadChildren: './construction/project-details/project-details.module#ProjectDetailsPageModule' },
        ...
        { path: 'construction/construction-view-completed',         loadChildren: './construction/construction-view-completed/construction-view-completed.module#ConstructionViewCompletedPageModule' },
